...
**RFID Card → EM-18 RFID Reader → 8051 Microcontroller (UID Capture & Verification) → LPC2129 Microcontroller → RTC Timestamp → LCD Display → Data Sent to PC → Linux Attendance Logging**
